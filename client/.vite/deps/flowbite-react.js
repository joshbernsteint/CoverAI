...
// node_modules/flowbite-react/node_modules/react-icons/lib/esm/iconBase.js
var import_react2 = __toESM(require_react());

// node_modules/flowbite-react/node_modules/react-icons/lib/esm/iconContext.js
...
function IconBase(props) {
  var elem = function(conf) {
    var attr2 = props.attr, size3 = props.size, title = props.title, svgProps = __rest(props, ["attr", "size", "title"]);
...
// node_modules/flowbite-react/node_modules/react-icons/hi/index.esm.js
...
var genericForwardRef = import_react6.forwardRef;
...
var Checkbox = (0, import_react12.forwardRef)(({ className, color = "default", theme: customTheme = {}, ...props }, ref) => {
...
// node_modules/flowbite-react/lib/esm/components/TextInput/TextInput.js
var TextInput = (0, import_react16.forwardRef)(({ addon, className, color = "gray", helperText, icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var Composite = React4.forwardRef(function Composite2(_ref, forwardedRef) {
  let {
    render,
    orientation = "both",
    loop = true,
...
var CompositeItem = React4.forwardRef(function CompositeItem2(_ref2, forwardedRef) {
  let {
    render,
    ...props
  } = _ref2;
...
function useInteractions(propsList) {
  ...
  const getReferenceProps = React4.useCallback((userProps) => mergeProps(userProps, propsList, "reference"), deps);
  const getFloatingProps = React4.useCallback((userProps) => mergeProps(userProps, propsList, "floating"), deps);
...
var Trigger = ({ refs, children, inline: inline3, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  if (renderTrigger) {
    ...
    return (0, import_react26.cloneElement)(triggerElement, { ref: refs.setReference, disabled, ...a11yProps, ...triggerElement.props });
  }
...
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  const [selectedIndex, setSelectedIndex] = (0, import_react26.useState)(null);
  const [buttonWidth, setButtonWidth] = (0, import_react26.useState)(void 0);
  const elementsRef = (0, import_react26.useRef)([]);
  const labelsRef = (0, import_react26.useRef)([]);
  ...
  const handleSelect = (0, import_react26.useCallback)((index3) => {
    setSelectedIndex(index3);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react26.useCallback)((index3) => {
    if (open) {
  ...
  const Icon = (0, import_react26.useMemo)(() => {
...
var FileInput = (0, import_react27.forwardRef)(({ className, color = "gray", helperText, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var FloatingLabel = (0, import_react28.forwardRef)(({ label, helperText, color = "default", sizing = "md", variant, disabled = false, theme: customTheme = {}, className, ...props }, ref) => {
...
var ModalContext = (0, import_react29.createContext)(void 0);
...
var ModalHeader = ({ as: Component = "h3", children, className, theme: customTheme = {}, id, ...props }) => {
  const innerHeaderId = (0, import_react30.useId)();
...
// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react32.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size3 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
  const [headerId, setHeaderId] = (0, import_react32.useState)(void 0);
...
var Radio = (0, import_react36.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
...
var RangeSlider = (0, import_react37.forwardRef)(({ className, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var RatingContext = (0, import_react38.createContext)(void 0);
function useRatingContext() {
  const context = (0, import_react38.useContext)(RatingContext);
  if (!context) {
...
var Select = (0, import_react39.forwardRef)(({ addon, children, className, color = "gray", helperText, icon: Icon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var SidebarContext = (0, import_react40.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react40.useContext)(SidebarContext);
  if (!context) {
...
var SidebarItemContext = (0, import_react43.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react43.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({ children, className, icon: Icon, label, chevronIcon: ChevronIcon = HiChevronDown, renderChevronIcon, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const [isOpen, setOpen] = (0, import_react44.useState)(open);
  const { theme: rootTheme, isCollapsed } = useSidebarContext();
  const theme2 = mergeDeep(rootTheme.collapse, customTheme);
  (0, import_react44.useEffect)(() => setOpen(open), [open]);
...
var SidebarItem = (0, import_react45.forwardRef)(({ active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", theme: customTheme = {}, ...props }, ref) => {
  var _a, _b, _c, _d;
...
var TableBodyContext = (0, import_react47.createContext)(void 0);
function useTableBodyContext() {
  const context = (0, import_react47.useContext)(TableBodyContext);
  if (!context) {
...
var TableContext = (0, import_react48.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react48.useContext)(TableContext);
  if (!context) {
...
var TableHeadContext = (0, import_react49.createContext)(void 0);
function useTableHeadContext() {
  const context = (0, import_react49.useContext)(TableHeadContext);
  if (!context) {
...
var TabsComponent = (0, import_react50.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().tabs, customTheme);
  const id = (0, import_react50.useId)();
  const tabs = (0, import_react50.useMemo)(() => import_react50.Children.map(import_react50.Children.toArray(children), ({ props: props2 }) => props2), [children]);
  const tabRefs = (0, import_react50.useRef)([]);
  const [activeTab, setActiveTab] = (0, import_react50.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
  const [focusedTab, setFocusedTab] = (0, import_react50.useState)(-1);
...
var Textarea = (0, import_react51.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
...
var TimelineContentContext = (0, import_react52.createContext)(void 0);
function useTimelineContentContext() {
  const context = (0, import_react52.useContext)(TimelineContentContext);
  if (!context) {
...
var TimelineContext = (0, import_react53.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react53.useContext)(TimelineContext);
  if (!context) {
...
var TimelineItemContext = (0, import_react54.createContext)(void 0);
function useTimelineItemContext() {
  const context = (0, import_react54.useContext)(TimelineItemContext);
  if (!context) {
...
var ToastContext = (0, import_react55.createContext)(void 0);
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react56.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react56.useState)(false);
